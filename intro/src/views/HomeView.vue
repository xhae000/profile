...
// Section2 data
const introText = `백엔드와 프론트엔드 개발 경험이 있으며 졸업 후 풀스택 개발자로 활동하고 싶습니다. Spring Boot, Vue, MySQL, AWS, Git, Figma 등을 활용하여 서비스의 기획부터 설계, 개발까지 주도적으로 진행해 본 경험이 있습니다. 프로덕션의 독창성, 확장성, 유지보수성을 가장 중요하게 생각하며 사용자에게 더 나은 경험을 제공하기 위해 항상 고민합니다. \n\n저는 소프트웨어로 우리 사회 속 문제를 해결하는 데에 관심이 많습니다. 그리고 이를 위한 가장 중요한 가치는 팀워크라고 믿습니다. 아무리 뛰어난 기술력을 가진 팀이라도 원활한 커뮤니케이션과 목표를 향한 능동적인 협업이 뒷받침되지 않는다면, 좋은 결과물을 만들어내긴 어렵습니다. 아직 개발 능력조차 부족한 학생 개발자이지만, 학부기간 동안은 개발이 아닌 다양한 경험을 통해 넓은 시야를 지니고자 노력하고 있습니다. 이를 바탕으로 조직 내에서 좋은 커뮤니케이터이자 문제를 뚝딱뚝딱 해결할 수 있는 개발자로 성장하고 싶습니다!`
